...
|----------------------|------------------------------------|-----------------------------|
| ![Product Input](example/input/labubu.jpg)<br><small>Resolution: 1080×1080<br>Format: JPG/PNG</small> | <br>[GLB Lightweight Model](example/glb_files/labubu.glb)<br>| ![Front View](example/output/labubu_3d_1.png)|
| ![Product Input](example/input/snaker.jpeg)<br><small>Resolution: 1080×1080<br>Format: JPG/PNG</small> | <br>[GLB Lightweight Model](example/glb_files/snaker.glb)<br>| ![Front View](example/output/snaker.png) |
